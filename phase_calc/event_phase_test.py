...
#cmd = f"{eventfile} {parfile} {temfile} --minWeight=0.1 --nwalkers=64 --nsteps=2500 --burnin 500 --clobber --usepickle --multicore --ncores 8 --no-autocorr --basename J1231_phase_calc_fseed --calc_phase --backend"
