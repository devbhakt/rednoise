...
cmd = f"{eventfile} {parfile} {temfile} --minWeight=0.1 --nwalkers=100 --nsteps=2500 --burnin 500 --clobber --usepickle --multicore --ncores 12 --no-autocorr --basename lin_original --backend"
#cmd = f"{eventfile} {parfile} {temfile} --minWeight=0.1 --nwalkers=100 --nsteps=2500 --burnin 500 --clobber --usepickle --multicore --ncores 8 --no-autocorr --basename lin_phase_calc --calc_phase --backend"
